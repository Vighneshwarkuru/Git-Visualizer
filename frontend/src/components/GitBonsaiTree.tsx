      ...
      <div className="flex items-center justify-between bg-[#131b2e] px-6 py-3 rounded-3xl border border-slate-800/80 backdrop-blur-md">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            disabled={!isPlaying}
            className="bg-slate-800 hover:bg-slate-700 disabled:opacity-40 px-3.5 py-1.5 rounded-3xl text-xs font-bold text-slate-200 transition-colors flex items-center gap-1.5 cursor-pointer"
          >
          ...
          <button
            ...
            className="bg-slate-800 hover:bg-slate-700 px-3.5 py-1.5 rounded-3xl text-xs font-bold text-slate-200 transition-colors flex items-center gap-1.5 cursor-pointer"
          >
